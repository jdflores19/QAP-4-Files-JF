# Library of formatting functions for use

def FPhoneNum(PhoneNumSet):
    # Function will accept a value and format it to (xxx)xxx-xxxx.

    PhoneNumStr = "(" + PhoneNumSet[0:3] + ")" + PhoneNumSet[3:6] + "-" + PhoneNumSet[6:10]
